...
void pir_sensor_init() {
  ...
  if(digitalRead(36)==1){ //If pin 22 reads a value of 1.  
    M5.Lcd.setCursor(0, 80);M5.Lcd.print("Sensing");
    M5.Lcd.setCursor(0, 110);M5.Lcd.print("1");
  }
  else{
    M5.Lcd.setCursor(0, 80);M5.Lcd.print("Not Sensed");
    M5.Lcd.setCursor(0, 110);M5.Lcd.print("0");
  }
  delay(50);
}